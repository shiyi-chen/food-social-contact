package com.elec.feeds.service;
...
import com.elec.commons.model.pojo.Feeds;
import com.elec.commons.model.vo.FeedsVO;
...
import com.elec.feeds.mapper.FeedsMapper;
...
public class FeedsService {
    ...
    public List<FeedsVO> selectForPage(Integer page, String accessToken) {
        ...
        ResultInfo resultInfo = restTemplate.getForObject(dinersServerName + "findByIds?access_token=${accessToken}&ids={ids}",
                ResultInfo.class, accessToken, Joiner.on(",").join(followingDinerIds));
